...
var service = scope.ServiceProvider.GetRequiredService<INonDeterministicFiniteAutomatonOrchestrator>();
...
{
    services.AddScoped<INonDeterministicFiniteAutomatonOrchestrator, NonDeterministicFiniteAutomatonOrchestrator>();
